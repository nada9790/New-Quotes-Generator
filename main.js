...
var generateQuote = function() { 
 var quotes=[
    ...
    document.getElementById("quotes").innerHTML = quotes[arrIndex].quote;
    document.getElementById("author").innerHTML = quotes[arrIndex].author;
    document.getElementById("profession").innerHTML = quotes[arrIndex].profession;
    document.getElementById("topics").innerHTML = quotes[arrIndex].topics;
}
